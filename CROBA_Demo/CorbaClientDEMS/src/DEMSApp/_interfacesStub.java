...
/**
* DEMSApp/_interfacesStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from DEMSApp.idl
* Wednesday, February 26, 2020 6:07:09 PM EST
*/

public class _interfacesStub extends org.omg.CORBA.portable.ObjectImpl implements DEMSApp.interfaces
{

  public String addEvent (String eventID, String eventType, int bookCap)
  {
            ...
            try {
                ...
                return addEvent (eventID, eventType, bookCap        );
            } finally {
                _releaseReply ($in);
            }
  } // addEvent
  ...
  public String getOwnlistEevntAvailability (String eventType)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getOwnlistEevntAvailability", true);
                $out.write_string (eventType);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
                ...
                return getOwnlistEevntAvailability (eventType        );
            } finally {
                _releaseReply ($in);
            }
  } // getOwnlistEevntAvailability
