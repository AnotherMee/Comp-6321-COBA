...
import DEMSApp.interfacesPOA;



public class QUE_ServerImp extends interfacesPOA 
{
	private ORB orb;
	...
	private HashMap<String, List<String>> customerHM = new HashMap<>();
	...
	public synchronized String listEventAvailability(String eventType) 
	{
		...
		System.out.println("reash listEvent");
		System.out.println(eventRecords);
		if (eventRecords.containsKey(eventType))
		{
			System.out.println("reash if");
			HashMap<String, BookingCapacity> events = eventRecords.get(eventType);
			for (String key: events.keySet())
			{
				System.out.println("reash for loop");
				eventIDs = key;
...
//			aSocket.close();
	...
	@Override
	public String getOwnlistEevntAvailability(String eventType) 
	{
		String eventIDs = null;
		String caps = null;
		String avaEvents = null;
		System.out.println(eventRecords + "QUEgetOwn");
		if (eventRecords.containsKey(eventType))
		{
			HashMap<String, BookingCapacity> events = eventRecords.get(eventType);
			for (String key: events.keySet())
	...
	{	
		...
		if (server.equals("QUE"))
		{
			try 
			{
				...
				System.out.println(cusHM +" QUEudp GET cs events");
				aSocket.close();
			...
			String oldEventType) 
	{
		...
		else if (cancel.equals("Cancel event unsuccessful") && book.equals("Booked the event successful"))
		{
